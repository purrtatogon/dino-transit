...
// Fake trains from the GTFS timetable: what *should* be running right now, lerped between stops.
// Handy when you have static GTFS; Metro Lisboa didn't ship me their bundle so Lisbon usually stays empty here.
@Service
